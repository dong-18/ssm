     ...
     <script type="text/javascript">
          function formSubmit(){
        	//校验用户输入的信息是否合法
  			...
  			if (!/^[a-zA-Z0-9_]{5,16}$/.test(loginName)) {
  				tip = "您输入的账号不合法！"
        	  ...
        	  $("#loginName").blur(function(){
        		  ...
        		  if(val){
        			  ...
        			  $.ajax({
        				  ...
        				  type : "post",
        				  data : "loginName="+val, // {loginName : val}
        				  dataType : "text",
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" value="" id="loginName" name="loginName"
							class="form-control" placeholder="请输入您的登陆名称"><span id="nameMsg"></span>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<label>会员:</label><input name="role" value="1" type="radio"
							checked="checked"> <label>管理员:</label><input
